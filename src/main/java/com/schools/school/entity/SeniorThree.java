...
public class SeniorThree {
    ...
    @Column(name = "NIN",nullable = true,unique = true,length = 14)
    ...
    public SeniorThree(Long id, String studentFirstName, String studentMidName, String studentLastName,
                     String studentDateOfBirth, String studentNationalIdentificationNumberNIN,
                     String studentGender, String studentClass, double feesToBeePaid, String studentHealthRecord,
                     String formerSchoolName, String reasonWhyChangedSchool, String formerSchoolPerformanceRecords,
                     String studentPhoto,
                     String studentHomeAddress, String studentSubCounty, String studentDistrict) {
        this.id = id;
