...
public class SeniorOnePayModel {
    ...
    public SeniorOnePayModel(Long id, String classRoom, String firstName, String minName, String lastName,
                             String photo, String feesOfPayment, double feesPaid, double feeBalance) {
        this.id = id;
